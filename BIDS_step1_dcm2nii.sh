...
subjList=(`cat ${workDir}/subjList.txt`)					# a column of subjects (e.g. sub-111 sub-112 sub-113)
session=gonogo												# scanning session - for raw data organization (ses-STT)
task=gonogo													# name of task, for epi data naming
	
epiDirs=(gonogo{1..3})										# epi dicom directory name/prefix
t1Dir=t1													# t1 ditto
expPhaseRuns=(1)											# Note 5
